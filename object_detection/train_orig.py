...
def main():
    ...
    model = models.__dict__[args.model](num_classes=91,
    ...
    # Data loading
    print("Loading data")
    ######### Note this "val" needs to be changed if using training set instead ##########
    dataset, num_classes = get_dataset(args, args.split, args.dataset, "val", get_transform(train=True), args.data_path, args.extra_input)
    dataset_test, num_classes = get_dataset(args, 'test', args.dataset, "val", get_transform(train=False), args.data_path, args.extra_input)
